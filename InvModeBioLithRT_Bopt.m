...
% Tune ph, CDOM, X
%global S_CDOM S_X g_size type_Rrs_below zB type_case_water fA g_dd g_dsr g_dsa f_dd f_ds alpha view view_w sun sun_w rho_L P RH Hoz WV  Rrs_obs

% Tune CDOM, X, g_size 
 global C_ph S_CDOM S_X type_Rrs_below zB type_case_water fA g_dd g_dsr g_dsa f_dd f_ds alpha view view_w sun sun_w rho_L P RH Hoz WV  Rrs_obs

% Tune CDOM, X
%global C_ph S_CDOM S_X g_size type_Rrs_below zB type_case_water fA g_dd g_dsr g_dsa f_dd f_ds alpha view view_w sun sun_w rho_L P RH Hoz WV  Rrs_obs

% Tune g_size, X
% global C_ph C_CDOM S_CDOM S_X type_Rrs_below zB type_case_water fA g_dd g_dsr g_dsa f_dd f_ds alpha view view_w sun sun_w rho_L P RH Hoz WV  Rrs_obs

%Tune X
%global C_ph C_CDOM S_CDOM S_X g_size type_Rrs_below zB type_case_water fA g_dd g_dsr g_dsa f_dd f_ds alpha view view_w sun sun_w rho_L P RH Hoz WV  Rrs_obs 
...
Ga_X=0.0177; % [m^2/mg] 
Oa_X=0;
abs_X_440= (Ga_X*C_X)+Oa_X; % [1/m], SPM abs. coeff. at 440 [nm]

abs_X=zeros(size(lambda));
...
bb_x=zeros(size(lambda)); % Backscattering coefficient for suspended particles [1/m]
